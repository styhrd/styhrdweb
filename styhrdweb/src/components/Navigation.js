...
const Navigation = ({ onComponentChange, toggleTheme }) => {
  ...
  return (
    <div className='nav'>
      ...
      <div className='profile'>
        <a className='profileicons' href="https://github.com/styhrd" target="_blank" rel="noopener noreferrer">
        ...
        <a className='profileicons' href="https://www.linkedin.com/in/juan-miguel-caparas-183210243/" target="_blank" rel="noopener noreferrer">
        ...
        <a className='profileicons' href="mailto:juanmiguelcaparas76@gmail.com" target="_blank" rel="noopener noreferrer">
