    ...
    return (
        <div className='anapolopage'>
            <div onClick={() => onBackToProjects('projects')} className='backbutt'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" shabs bi bi-arrow-left icon" viewBox="0 0 16 16">
            ...
            <div className='anapolofeatures'>
                ...
                <div className='stack'>
                    ...
                    <p className='featdesc'>
                        The web application was developed using PHP for server-side scripting, MySQL for database management, and Apache as the web server. PHP handled dynamic content and user interactions, MySQL managed data storage and retrieval, and Apache served as the platform for hosting the application. The hands-on experience gained from creating this thesis application has been valuable in understanding web development intricacies.
                    </p>
                    ...
                    <a href='http://anapolothesis.wuaze.com/' target='_blank'>VISIT THE WEBSITE HERE</a>
                </div>
            </div>
